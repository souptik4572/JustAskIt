...
urlpatterns = [
    ...
    path('location/<int:location_id>/edit/', edit_existing_location, name='api.edit_existing_location'),
    path('location/<int:location_id>/delete/', delete_existing_location, name='api.delete_existing_location')
]
